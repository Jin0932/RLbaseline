...
if __name__ == "__main__":
	...
	run = wandb.init(
		project="CompareAlgo",
		entity="lzudslab",
		group=f"{args.env}_{args.policy}_seed={args.seed}",
		job_type = f"seed={args.seed}",
		name = f"{args.env}_{args.policy}_seed={args.seed}",
	...
	for t in range(int(args.max_timesteps)):
		...
		wandb.log({"episode_reward":episode_reward}, step=t)
		...
		if (t + 1) % args.eval_freq == 0:
			...
			wandb.log({"eval_reward":eval_reward}, step=t)
